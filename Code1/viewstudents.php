...
<body style= "background-image: url(https://wallpaperaccess.com/full/6891669.jpg);background-attachment:fixed; background-repeat: no-repeat">
<div class="container">
<div class="container">
    ...
    <h4 class="center-block">
	    ...
	    <strong style="font-size:23px">Student Table</strong></h4>
	</div>
