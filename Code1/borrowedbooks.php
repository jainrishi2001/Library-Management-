<?php
   ...
   ?>
<body style=" background-image: url(https://wallpaperaccess.com/full/3133177.jpg); background-attachment:fixed; background-repeat: no-repeat">
<div class="container">
   ...
   <span class="glyphicon glyphicon-book"></span>
      <strong style ="font-size:23px">Issued Books</strong></h4>
   </div>
</div>
<div class="container">
